-- Update the trigger to allow new origin states for EXTRA batches
-- EXTRA batches use origin_state to track where they were created (extra_manufacturing, extra_finishing, etc.)
-- and current_state to track their position in the pipeline
