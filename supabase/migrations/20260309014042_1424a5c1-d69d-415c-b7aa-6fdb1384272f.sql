...
BEGIN
  ...
  FOR v_batch IN
    SELECT id, quantity, order_id, product_id, order_item_id, current_state,
           created_by, eta, lead_time_days, from_extra_state, box_id
    FROM order_batches
  ...
  LOOP
    ...
    ELSE
      ...
      -- Insert remainder batch (no machine) - inherit from_extra_state and box_id
      INSERT INTO order_batches (
        order_id, product_id, order_item_id, current_state,
        quantity, created_by, eta, lead_time_days, from_extra_state, box_id
      ) VALUES (
        ...
        v_batch.from_extra_state, v_batch.box_id
      );
