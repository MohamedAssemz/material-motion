  ...
  const fetchOrders = async () => {
    try {
      const { data, error } = await supabase
        ...
        `)
        .or('current_state.eq.ready_for_finishing,current_state.eq.in_finishing', { foreignTable: 'batches' });
