...
export const translations: Record<string, TranslationEntry> = {
  ...
  "orders.deducted_to_extra_hint": { en: "{count} units already moved to Extra Inventory. You may reduce this order item by up to {count} (or all the way to 0 to mirror a fully-cancelled line) without affecting production — this only updates the order document to match what was actually shipped. The surplus stays safely in Extra Inventory.", ar: "تم نقل {count} وحدة بالفعل إلى المخزون الإضافي. يمكنك تقليل هذا العنصر بحد أقصى {count} (أو حتى 0 لمحاكاة بند ملغى بالكامل) دون التأثير على الإنتاج — هذا يُحدّث مستند الطلب فقط ليطابق ما تم شحنه فعلياً. تبقى الكميات الفائضة بأمان في المخزون الإضافي." },
  ...
  "warehouse.empty_boxes_in":     { en: "Empty Boxes",          ar: "صناديق فارغة" },
  "warehouse.available_units_in": { en: "Available Units",      ar: "وحدات متاحة" },
  "common.size":                  { en: "Size",                 ar: "المقاس" },
  "catalog.minimum_quantity":     { en: "Minimum Quantity",     ar: "الحد الأدنى للكمية" },
  "catalog.minimum_quantity_helper": { en: "Informational only — does not affect production logic", ar: "للعرض فقط — لا يؤثر على منطق الإنتاج" },
  ...
  "warehouse_settings.title":         { en: "Warehouse Settings",       ar: "إعدادات المخزن" },
  "warehouse_settings.subtitle":      { en: "Manage your storehouses",  ar: "إدارة المخازن" },
  "warehouse_settings.list_title":    { en: "Storehouses",              ar: "المخازن" },
  "warehouse_settings.add":           { en: "Add Storehouse",           ar: "إضافة مخزن" },
  "warehouse_settings.edit":          { en: "Edit Storehouse",          ar: "تعديل المخزن" },
  "warehouse_settings.name":          { en: "Name",                     ar: "الاسم" },
  "warehouse_settings.empty":         { en: "No storehouses yet",       ar: "لا توجد مخازن" },
  "warehouse_settings.delete_title":  { en: "Delete Storehouse",        ar: "حذف المخزن" },
  "warehouse_settings.delete_confirm":{ en: "Are you sure you want to delete", ar: "هل أنت متأكد من حذف" },
  "warehouse_settings.in_use_error":  { en: "Cannot delete: storehouse is used by existing extra boxes", ar: "لا يمكن الحذف: المخزن مستخدم في صناديق إضافية" },
  "warehouse_settings.read_only":     { en: "View only — admin role required to make changes.", ar: "عرض فقط — صلاحية المسؤول مطلوبة للتعديل." },
  "warehouse_settings.button":        { en: "Settings",                 ar: "الإعدادات" },
  "extra_analysis.button":            { en: "Analysis",                 ar: "تحليل" },
  "extra_analysis.title":             { en: "Extra Inventory Analysis", ar: "تحليل المخزون الإضافي" },
  "extra_analysis.subtitle":          { en: "Stock health vs. minimum thresholds", ar: "حالة المخزون مقابل الحد الأدنى" },
  "extra_analysis.search_placeholder":{ en: "Search by product name or SKU…", ar: "ابحث بالاسم أو الكود…" },
  "extra_analysis.filter.all":        { en: "All statuses",             ar: "كل الحالات" },
  "extra_analysis.col.product":       { en: "Product",                  ar: "المنتج" },
  "extra_analysis.col.available":     { en: "Available",                ar: "المتاح" },
  "extra_analysis.col.minimum":       { en: "Minimum",                  ar: "الحد الأدنى" },
  "extra_analysis.col.delta":         { en: "Delta",                    ar: "الفرق" },
  "extra_analysis.col.status":        { en: "Status",                   ar: "الحالة" },
  "extra_analysis.status.red":        { en: "Critical",                 ar: "حرج" },
  "extra_analysis.status.yellow":     { en: "Low",                      ar: "منخفض" },
  "extra_analysis.status.normal":     { en: "Healthy",                  ar: "جيد" },
  "extra_analysis.size_breakdown":    { en: "Size breakdown",           ar: "تفصيل المقاسات" },
  "extra_analysis.no_size":           { en: "No size",                  ar: "بدون مقاس" },
  "extra_analysis.no_stock":          { en: "No available stock",       ar: "لا يوجد مخزون متاح" },
  "extra_analysis.empty_state":       { en: "No products to display",   ar: "لا توجد منتجات للعرض" },
  "extra_analysis.summary.critical":  { en: "Critical",                 ar: "حرج" },
  "extra_analysis.summary.warning":   { en: "Low",                      ar: "منخفض" },
  "extra_analysis.summary.healthy":   { en: "Healthy",                  ar: "جيد" },
  ...
  "audit.action.order.created":                       { en: "Order Created", ar: "تم إنشاء الطلب" },
  "audit.action.order.started":                       { en: "Order Started", ar: "تم بدء الطلب" },
  "audit.action.order.edited":                        { en: "Order Edited", ar: "تم تعديل الطلب" },
  "audit.action.order.cancelled":                     { en: "Order Cancelled", ar: "تم إلغاء الطلب" },
  "audit.action.extra_inventory.committed":           { en: "Extra Inventory Committed", ar: "تم تثبيت المخزون الإضافي" },
  "audit.action.extra_inventory.reserved":            { en: "Extra Inventory Reserved", ar: "تم حجز المخزون الإضافي" },
  "audit.action.extra_inventory.injected":            { en: "Extra Inventory Injected", ar: "تم ضخ المخزون الإضافي" },
  "audit.action.extra_inventory.assigned_to_box":     { en: "Extra Assigned to Box", ar: "تم تعيين الإضافي إلى الصندوق" },
  "audit.action.extra_inventory.moved_directly":      { en: "Extra Moved Directly", ar: "تم نقل الإضافي مباشرة" },
  "audit.action.extra_batch.created":                 { en: "Extra Batch Created", ar: "تم إنشاء دفعة إضافية" },
  "audit.action.extra_batch.assigned_to_box":         { en: "Extra Batch Assigned to Box", ar: "تم تعيين الدفعة الإضافية إلى الصندوق" },
  "audit.action.extra_batch.deleted":                 { en: "Extra Batch Deleted", ar: "تم حذف الدفعة الإضافية" },
  "audit.action.extra_batch.force_unreserved":        { en: "Extra Batch Force Unreserved", ar: "تم إلغاء حجز الدفعة الإضافية قسراً" },
  "audit.action.shipment.created":                    { en: "Shipment Created", ar: "تم إنشاء الشحنة" },
  "audit.action.shipment.sealed":                     { en: "Shipment Sealed", ar: "تم ختم الشحنة" },
  "audit.action.shipment.reprinted":                  { en: "Shipment Reprinted", ar: "تمت إعادة طباعة الشحنة" },
  "audit.action.batch.start_working":                 { en: "Started Working on Batch", ar: "تم بدء العمل على الدفعة" },
  "audit.action.batch.assigned_to_box":               { en: "Assigned to Box", ar: "تم التعيين إلى الصندوق" },
  "audit.action.batch.received":                      { en: "Batch Received", ar: "تم استلام الدفعة" },
  "audit.action.batch.moved_to_extra":                { en: "Moved to Extra", ar: "تم النقل إلى الإضافي" },
  "audit.action.batch.moved_to_next":                 { en: "Moved to Next Phase", ar: "تم الانتقال للمرحلة التالية" },
  "audit.action.batch.moved_to_ready_for_shipment":   { en: "Ready for Shipment", ar: "جاهز للشحن" },
  "audit.action.batch.machine_assigned":              { en: "Machine Assigned", ar: "تم تعيين الماكينة" },
  "audit.action.box.created":                         { en: "Box Created", ar: "تم إنشاء الصندوق" },
  "audit.action.box.force_emptied":                   { en: "Box Force Emptied", ar: "تم إفراغ الصندوق قسراً" },
  "audit.action.box.deleted":                         { en: "Box Deleted", ar: "تم حذف الصندوق" },
  ...
  "audit.action.product.bulk_uploaded":               { en: "Products Bulk Uploaded", ar: "تم رفع المنتجات بالجملة" },

  // Timeline module labels
  "audit.module.orders":            { en: "Orders", ar: "الطلبات" },
  "audit.module.manufacturing":     { en: "Manufacturing", ar: "التصنيع" },
  "audit.module.finishing":         { en: "Finishing", ar: "التشطيب" },
  "audit.module.packaging":         { en: "Packaging", ar: "التغليف" },
  "audit.module.boxing":            { en: "Boxing", ar: "التعبئة" },
  "audit.module.shipments":         { en: "Shipments", ar: "الشحنات" },
  "audit.module.extra_inventory":   { en: "Extra Inventory", ar: "المخزون الإضافي" },
  "audit.module.boxes":             { en: "Boxes", ar: "الصناديق" },
  "audit.module.catalog":           { en: "Catalog", ar: "الكتالوج" },
  "audit.module.admin":             { en: "Admin", ar: "الإدارة" },
};
