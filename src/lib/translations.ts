...
export const translations: Record<string, TranslationEntry> = {
  ...
  // Phase page: receive/process tab common
  "phase.receive_boxes":        { en: "Receive Boxes",  ar: "استلام الصناديق" },
  "phase.process_items":        { en: "Process Items",  ar: "معالجة العناصر" },
  "phase.accept_n_boxes":       { en: "Accept Box(es)", ar: "قبول الصناديق" },
  "phase.type_to_filter":       { en: "Type to filter boxes...", ar: "اكتب لتصفية الصناديق..." },
  "phase.search_box_product":   { en: "Search by Box Code, Product SKU, or Name", ar: "ابحث بكود الصندوق أو رمز المنتج أو الاسم" },
  "phase.no_boxes_matching":    { en: "No boxes matching", ar: "لا توجد صناديق تطابق" },
  "phase.no_boxes_ready_for":   { en: "No boxes ready for this phase", ar: "لا توجد صناديق جاهزة لهذه المرحلة" },
  "phase.clear":                { en: "Clear",          ar: "مسح" },
  "phase.items_label":          { en: "items",          ar: "عناصر" },
  "phase.select_quantities":    { en: "Select quantities below, then choose an action", ar: "حدد الكميات أدناه، ثم اختر إجراء" },
  "phase.move_to_extra":        { en: "Move to Extra",  ar: "نقل للإضافي" },
  "phase.assigning":            { en: "Assigning...",   ar: "جاري التعيين..." },
  "phase.assign":               { en: "Assign",         ar: "تعيين" },
  "phase.or_select_from_available": { en: "Or Select from Available Boxes", ar: "أو اختر من الصناديق المتاحة" },

  // Phase page: header/stats/tabs
  "phase.view_order_details":   { en: "View Order Details", ar: "عرض تفاصيل الطلب" },
  "phase.high_priority":        { en: "High Priority",    ar: "أولوية عالية" },
  "phase.in_manufacturing":     { en: "In Manufacturing", ar: "في التصنيع" },
  "phase.in_finishing":         { en: "In Finishing",     ar: "في التشطيب" },
  "phase.in_packaging":         { en: "In Packaging",    ar: "في التعبئة" },
  "phase.in_boxing":            { en: "In Boxing",        ar: "في التعليب" },
  ...
  "phase.receive_tab":          { en: "Receive",          ar: "استلام" },
  "phase.process_tab":          { en: "Process",          ar: "معالجة" },
  "phase.completed_tab":        { en: "Completed",        ar: "مكتمل" },
  "phase.select_items_first":   { en: "Please select items first", ar: "يرجى تحديد العناصر أولاً" },
  "phase.assign_to_box":        { en: "Assign to Box",    ar: "تعيين إلى صندوق" },
  "phase.assign_to_extra":      { en: "Assign to Extra",  ar: "تعيين للإضافي" },
  "phase.no_items_in_phase":    { en: "No items in this phase for this order", ar: "لا توجد عناصر في هذه المرحلة لهذا الطلب" },
  "phase.cancelled_order_msg":  { en: "This order has been cancelled. Actions are frozen except machine assignment.", ar: "تم إلغاء هذا الطلب. الإجراءات مجمدة باستثناء تعيين الماكينة." },
  "phase.selected":             { en: "selected",         ar: "محدد" },
  "phase.in_mfg":               { en: "In Mfg",           ar: "في التصنيع" },
  "phase.select_label":         { en: "Select",           ar: "تحديد" },
  "phase.needs_packing":        { en: "Needs Packing",    ar: "يحتاج تعبئة" },
  "phase.no_packing":           { en: "No Packing",       ar: "بدون تعبئة" },
  "phase.boxing_label":         { en: "Boxing",           ar: "تعليب" },
  "phase.no_boxing":            { en: "No Boxing",        ar: "بدون تعليب" },
  "phase.ready_for_finishing":  { en: "Ready for Finishing", ar: "جاهز للتشطيب" },
  "phase.ready_for_packaging":  { en: "Ready for Packaging", ar: "جاهز للتعبئة" },
  "phase.ready_for_boxing":     { en: "Ready for Boxing", ar: "جاهز للتعليب" },
  "phase.boxes_waiting":        { en: "Boxes Waiting",    ar: "صناديق في الانتظار" },
  "phase.products_in_phase":    { en: "Products in Phase", ar: "المنتجات في المرحلة" },
  "phase.select_all":           { en: "Select All",       ar: "تحديد الكل" },
  "phase.deselect_all":         { en: "Deselect All",     ar: "إلغاء التحديد" },
  "phase.no_completed_yet":     { en: "No completed items yet", ar: "لا توجد عناصر مكتملة بعد" },
  "phase.added_to_extra_order": { en: "Added to Extra from this Order", ar: "أُضيف للإضافي من هذا الطلب" },
  "phase.to_extra":             { en: "to extra",         ar: "للإضافي" },
  "phase.machine_optional":     { en: "Machine (Optional)", ar: "الماكينة (اختياري)" },
  "phase.box_selection":        { en: "Box Selection",    ar: "اختيار الصندوق" },
  "phase.search_box_code":      { en: "Search Box by Code", ar: "البحث بكود الصندوق" },
  "phase.enter_box_number":     { en: "Enter box number", ar: "أدخل رقم الصندوق" },
  "phase.no_boxes_matching_search": { en: "No boxes matching your search", ar: "لا توجد صناديق تطابق بحثك" },
  "phase.scan":                 { en: "Scan",             ar: "مسح" },
  "phase.order_not_found":      { en: "Order not found",  ar: "الطلب غير موجود" },
  ...
  // Catalog page
  "catalog.title":              { en: "Product Catalog",  ar: "كتالوج المنتجات" },
  "catalog.products_count":     { en: "products",         ar: "منتجات" },
  "catalog.catalog_insights":   { en: "Catalog Insights", ar: "رؤى الكتالوج" },
  ...
  "catalog.bulk_upload":        { en: "Bulk Upload",      ar: "رفع جماعي" },
  "catalog.add_product":        { en: "Add Product",      ar: "إضافة منتج" },
  "catalog.search_placeholder": { en: "Search products by name, SKU, or description...", ar: "ابحث بالاسم أو رمز المنتج أو الوصف..." },
  "catalog.clear_filters":      { en: "Clear filters",    ar: "مسح الفلاتر" },
  "catalog.all_categories":     { en: "All Categories",   ar: "جميع الفئات" },
  "catalog.all_brands":         { en: "All Brands",       ar: "جميع العلامات" },
  "catalog.all_sizes":          { en: "All Sizes",        ar: "جميع الأحجام" },
  "catalog.all_countries":      { en: "All Countries",    ar: "جميع الدول" },
  "catalog.no_products_yet":    { en: "No products yet",  ar: "لا توجد منتجات بعد" },
  "catalog.no_match":           { en: "No products match your filters", ar: "لا توجد منتجات تطابق الفلاتر" },
  "catalog.get_started":        { en: "Get started by adding your first product", ar: "ابدأ بإضافة أول منتج" },
  "catalog.try_adjusting":      { en: "Try adjusting your filters", ar: "حاول تعديل الفلاتر" },
  "catalog.products_appear":    { en: "Products will appear here once added", ar: "ستظهر المنتجات هنا بمجرد إضافتها" },
  ...
  "reports.no_country_data":    { en: "No country data for selected range", ar: "لا توجد بيانات دول للنطاق المحدد" },
  "reports.no_customer_data":   { en: "No customer data for selected range", ar: "لا توجد بيانات عملاء للنطاق المحدد" },
  "reports.items_processed":    { en: "Items Processed Per Phase", ar: "العناصر المعالجة لكل مرحلة" },
  ...
  "reports.units_per_machine_desc": { en: "Total units assigned per machine in selected period", ar: "إجمالي الوحدات المخصصة لكل ماكينة في الفترة المحددة" },
  "reports.units_day_type":     { en: "Units per day, stacked by machine type", ar: "الوحدات يومياً، مكدسة حسب نوع الماكينة" },
  "reports.units_per_phase_desc": { en: "Total units assigned per production phase", ar: "إجمالي الوحدات المخصصة لكل مرحلة إنتاج" },
  "reports.leaderboard_desc":   { en: "Ranked by total units, with trend vs previous half of period", ar: "مرتبة حسب إجمالي الوحدات، مع الاتجاه مقارنة بالنصف السابق" },
  "reports.no_machine_period":  { en: "No machine data for selected period", ar: "لا توجد بيانات ماكينات للفترة المحددة" },
  "reports.no_phase_data":      { en: "No phase data available", ar: "لا توجد بيانات مراحل متاحة" },
};
