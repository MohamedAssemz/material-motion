...
import ExtraInventoryAnalysis from "./pages/ExtraInventoryAnalysis";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/extra-inventory/analysis" element={<ProtectedPage><ExtraInventoryAnalysis /></ProtectedPage>} />
